...
#if 0	
static void dm9051_sys_core_clock_init(void)
{
...
/**
  ...
  */
#if 0
static void _ethernetif_notify_conn_changed(struct netif *netif)
{
  ...
  */
  ...
  if (netif_is_link_up(netif)) {
	...
	dhcp_start(netif);
#endif
	dm9051_link_show(); //dm9051_show_link(); //already must link-up
  }
  else
