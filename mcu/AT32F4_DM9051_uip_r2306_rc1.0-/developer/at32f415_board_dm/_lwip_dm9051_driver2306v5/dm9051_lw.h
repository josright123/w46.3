...
//void DM9051_Read_Mem(u8 *buf, u16 len);
//void DM9051_Write_Mem(u8 *buf, u16 len);
...
static void dm9051_mac_adr(uint8_t *macadd); //ethernetif.c (_lwip_set_mac_address())
static void dm9051_rx_mode(void); //ethernetif.c (of _lwip_set_mac_address())
...
#if 0
/* [espacial software hi/lo usage..] */
#define SPI_DM9051_CLK_LOW()       GPIOB->clr = GPIO_PINS_13
#define SPI_DM9051_CLK_HIGH()      GPIOB->scr = GPIO_PINS_13
#define SPI_DM9051_MISO_LOW()      GPIOB->clr = GPIO_PINS_14 //.by (gpio_input_data_bit_read(GPIOB, GPIO_PINS_14))
#define SPI_DM9051_MISO_HIGH()     GPIOB->scr = GPIO_PINS_14 //.by (gpio_input_data_bit_read(GPIOB, GPIO_PINS_14))
#define SPI_DM9051_MOSI_LOW()      GPIOB->clr = GPIO_PINS_15
#define SPI_DM9051_MOSI_HIGH()     GPIOB->scr = GPIO_PINS_15
...
//static void dm9051_update_flags(int linkup);
