...
{
	//Nibble transport = 0x80; //(spec annex D), header->transportSpecific. majorSdoId: 0x00, minorSdoId: 0x00
	Nibble transport = 0x00;   //(spec annex D), originally 0x80, microchip uses 0x00.
